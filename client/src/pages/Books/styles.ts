const classname = {
  ...
  container: "justify-center flex gap-4 flex-wrap",
  card: "border border-gray-400 bg-white w-[270px] h-[400px] rounded-md p-2 flex flex-col", // two last properties needed to apply the last styles on price to be at the bottom of the card
